...
<body id="page-top">
  ...
  <!-- Page Wrapper -->   <!-- Sidebar -->
   <!-- <ul style="baground:green" class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar"> -->
    ...
    <!-- <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
      ...
      <div class="sidebar-brand-text mx-3">PALMAFRIQUE CI</div>
    </a> -->
      ...
      <!-- <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-danger py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="buttons.html">La region</a>
            <a class="collapse-item" href="cards.html">Le sexe</a>
            <a class="collapse-item" href="buttons.html">L'annee</a>
            <a class="collapse-item" href="cards.html">Le mois</a>
            <a class="collapse-item" href="buttons.html">La l'unite de travail</a>
            <a class="collapse-item" href="cards.html">Le la tranche d'age</a>
          </div>
        </div>
      </li> -->
